        ...
        <div id="page-wrapper">
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tr v-for="item, index in products">
                    ...
                    <td><a href="#" @click.prevent="khoiphucProduct(item.MaSP,index)"><span class="glyphicon glyphicon-trash"></span></a></td>
                </tr>
                </tbody>
            </table>
...
<script>
    ...
    export default {
        ...
        mounted(){
            var app = this;
            axios.get('/admin/product/deleted')
        ...
        methods:{
            ...
            khoiphucProduct(id,index){
                if(confirm('Khôi phục sản phẩm này?')){
                    var app = this;
                    axios.get('/admin/product/recovery/'+id)
                        .then(function(response){
                            app.products = response.data;
                            alert('Đã khôi phục!');
                        })
