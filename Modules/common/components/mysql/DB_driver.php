<?php
namespace Modules\common\components\mysql;
class DB_driver
{
    ...
    function connect()
    {
        ...
        if (!$this->__conn){
            // Kết nối
            $this->__conn = mysqli_connect('db', 'root', 'root', 'gaminggear') or die ('Lỗi kết nối');
...
// Hàm Insert
    function insert($table, $data)
    {
        ...
        if(mysqli_query($this->__conn, $sql)){
            ...
            return "Error description: " . mysqli_error($this->__conn);
        }
    }
