                    ...
                    <form class="form-them" data-toggle="validator" action="admin/thuonghieu/them" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="help-block with-errors"></div>
                              ...
                              <div class="form-group">
                          <label class="control-label" for="title">Địa Chỉ</label>
      
                          <input type="text" id="diaChi" name="diaChi" class="form-control" data-error="Please enter title." required />
                          
                          <div class="help-block with-errors"></div>
      
                      </div>
                      <div class="form-group">
                        <label class="control-label" for="title">Số ĐT</label>
    
                        <input type="text" id="sdt" name="sdt" class="form-control" data-error="Please enter title." required />
